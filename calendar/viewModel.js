        ...
        function(){
            ...
            function c(){
                ...
                for(var c=0;c<42-r;c++){
                     ...
                     */
                        ...
                        let workerName=checkVacationDay(new Date(currentYear,currentMonth-1,v),employees);
                        if(workerName){
                                if(m) m+=' vacation">';
            ...
            function adjustSize(){
                ...
                for(let hijo of n.find(".checked")){
                    console.log(hijo)
                    //hijo.children("div").css({width:100/hijo.children.length-1+"%"})
                ...
                //console.log(n.find(".checked"))
                console.log(n.find(".checked").children("div"))
            }
            /**
